# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/08_tile_clustering.ipynb.

# %% auto 0
__all__ = ['TileClustering']

# %% ../nbs/08_tile_clustering.ipynb 5
import pandas as pd
...
# %% ../nbs/08_tile_clustering.ipynb 6
...
# %% ../nbs/08_tile_clustering.ipynb 7
@patch
def cluster_tiles(
    self: TileClustering,
    df: pd.DataFrame,
...
# %% ../nbs/08_tile_clustering.ipynb 8
@patch
