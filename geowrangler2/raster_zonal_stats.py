# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_raster_zonal_stats.ipynb.

# %% auto 0
__all__ = ['create_raster_zonal_stats']

# %% ../nbs/03_raster_zonal_stats.ipynb 7
...
# %% ../nbs/03_raster_zonal_stats.ipynb 8
def create_raster_zonal_stats(
    ...
    aggregation: Dict[  # A dict specifying the aggregation. See `create_zonal_stats` from the `geowrangler2.vector_zonal_stats` module for more details
        str, Any
    ],
    ...
    the `rasterstats` python package for compatibility with other geowrangler2 modules.
