# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_vector_zonal_stats.ipynb.

# %% auto 0
__all__ = ['create_zonal_stats', 'compute_quadkey', 'create_bingtile_zonal_stats']

# %% ../nbs/02_vector_zonal_stats.ipynb 5
GEO_INDEX_NAME = "__GeoWrangleer_aoi_index"

# %% ../nbs/02_vector_zonal_stats.ipynb 6
...
# %% ../nbs/02_vector_zonal_stats.ipynb 10
def _fix_agg(
...
# %% ../nbs/02_vector_zonal_stats.ipynb 15
def _check_agg(
    agg: Dict[str, Any],  # A dict containing at the minimum a 'func' key
...
# %% ../nbs/02_vector_zonal_stats.ipynb 18
def _validate_aggs(
...
# %% ../nbs/02_vector_zonal_stats.ipynb 23
def _validate_aoi(
...
# %% ../nbs/02_vector_zonal_stats.ipynb 24
def _expand_aggs(
...
# %% ../nbs/02_vector_zonal_stats.ipynb 26
def _build_agg_args(
...
# %% ../nbs/02_vector_zonal_stats.ipynb 28
def _prep_aoi(
...
# %% ../nbs/02_vector_zonal_stats.ipynb 33
def _fillnas(
...
# %% ../nbs/02_vector_zonal_stats.ipynb 37
...
# %% ../nbs/02_vector_zonal_stats.ipynb 43
...
# %% ../nbs/02_vector_zonal_stats.ipynb 69
...
# %% ../nbs/02_vector_zonal_stats.ipynb 70
